...
public class OrganizationConfig
{
	...
	{
		Address address = new Address("kadapa", "andhra pradesh");	
		return address;
	} 
	...
	public List<String> getDirectors()
	{
		...
		directors.add("cherry"); 
		directors.add("charitha");
		return directors;
	}
	...
	public Map<String, String> getBranchWiseHead()
	{
		...
		branchWiseHead.put("kadapa","mounika");
		branchWiseHead.put("nellore","raji");
		branchWiseHead.put("hyderabad","harika");
